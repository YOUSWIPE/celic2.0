      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24 reveal-up">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-3 text-foreground/70 font-bold">
                ...
                <a href="mailto:schlosserei@celic.at" className="hover:text-primary transition-colors">schlosserei@celic.at</a>
              </div>
              <div className="flex items-start space-x-3 text-foreground/70 font-bold leading-tight">
          ...
          <div className="bg-primary/5 p-8 rounded-3xl space-y-4 border border-primary/10">
            <h4 className="text-primary font-extrabold text-xl">Ihr Sicherheits-Partner</h4>
            <p className="text-foreground/70 font-bold text-sm leading-relaxed">
              Wir beraten Sie gerne ausführlich. Rufen Sie uns für eine Terminvereinbarung an.
            </p>
